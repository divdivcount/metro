<?php
	...
	class ProLogin extends MetroDAO {
		...
		public function InternalIP() {
			if(startsWith($_SERVER['REMOTE_ADDR'], '192.168.') || $_SERVER['REMOTE_ADDR'] === '127.0.0.1' || $_SERVER['REMOTE_ADDR'] === '::1' || $_SERVER['REMOTE_ADDR'] === '121.165.86.230' || $_SERVER['REMOTE_ADDR'] === '58.227.107.83') {//localhost
