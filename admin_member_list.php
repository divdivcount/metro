...
<body>
  <div class="container">
    <div class="search">
      <form action="admin_member_list.php" method="get" id="fromid">
    ...
    <div class="content">
      <div class="content_table">
        ...
        <?php foreach ($list as $admin_lists): ?>
                <tr class="content_tr" style="cursor:pointer;" onclick="location.href='admin_member_detail.php?all=<?=$admin_lists["mb_name"]?>&mball=<?=$admin_lists["mb_id"]?>'">
