  ...
  <div id="wrapPage">
    ...
    <div id="subContent_box">
      ...
      <div id="recentProducts_gridbox">
        ...
        <a href="searchProduct_detail.php?id=<?=$product_result['pr_id']?>&title=<?=$product_result['pr_title']?>&line=<?=$product_result['l_id']?>&station=<?=$product_result['pr_station']?>"><div class="recent_productInfo_box">
  ...
  document.getElementById('moreInfo_btn').addEventListener("click",changeBtn_style);
    ...
    function changeBtn_style() {
      if (document.getElementById('moreInfo_btn').dataset.tf=="0") {
        changeWidth_RecentProducts_gridbox(8);
  ...
  window.addEventListener("resize", changeContent);
    ...
    function changeContent() {
      ...
      if (w_width <= 768) {
        ...
        // var bx_viewport= document.querySelector(".bx_viewport");
        // bx_viewport.style.height = want_height + "px";
        for (var i = 0; i < bx_img_array.length; i++) {
          bx_img_array.item(i).style.height = want_height + "px";
        }
      }else{
        for (var i = 0; i < bx_img_array.length; i++) {
          bx_img_array.item(i).style.height = "auto";
        }
      }
